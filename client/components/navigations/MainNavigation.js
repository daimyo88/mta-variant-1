...
const getCollapseInitialState = (router) => {
    if (router.pathname.indexOf("stats") !== -1 && !router.query?.id) {
        return "stats";
    }
...
export default function MainNavigation() {
    ...
    const [collapseState, setCollapseState] = useState(
        getCollapseInitialState(router) || ""
    );
    const user = useUser();
    ...
    return (
        <List component="nav">
            <ListItem
                button
                divider
                onClick={() => menuItemClickHandler("stats")}
            >
                <ListItemIcon>
                    <EqualizerIcon />
                </ListItemIcon>
            ...
            <Collapse
                in={collapseState === "stats"}
                timeout="auto"
                unmountOnExit
            >
                <Link href="/admin/stats/prices">
                    <a className={classes.listItemInner}>
                        <ListItem
                            button
                            divider
                            selected={
                                router.pathname === "/admin/stats/prices"
                            }
                        >
                            <ListItemText primary={t("menu:prices")} />
                        </ListItem>
                    </a>
                </Link>
                <Link href="/admin/stats/product-groups">
                    <a className={classes.listItemInner}>
                        <ListItem
                            button
                            divider
                            selected={router.pathname === "/admin/stats/product-groups"}
                        >
                            <ListItemText primary={t("menu:product-groups")} />
                        </ListItem>
                    </a>
                </Link>
            </Collapse>
                ...
                <Link href="/admin/data-entries/new">
                    <a className={classes.listItemInner}>
                        <ListItem
                            ...
                            divider
                            selected={
                                router.pathname === "/admin/data-entries/new"
                            }
                        >
                ...
                <Link href="/admin/transports/new">
                    <a className={classes.listItemInner}>
                        <ListItem
                            ...
                            divider
                            selected={
                                router.pathname === "/admin/transports/new"
                            }
                        >
                    ...
                    <Link href="/admin/locations/new">
                        <a className={classes.listItemInner}>
                            <ListItem
                                ...
                                divider
                                selected={
                                    router.pathname === "/admin/locations/new"
                                }
                            >
                                <ListItemText
                                    primary={t("menu:new-location")}
                                />
                            </ListItem>
                        </a>
                    </Link>
                    ...
                    <Link href="/admin/users/new">
                        <a className={classes.listItemInner}>
                            <ListItem
                                ...
                                divider
                                selected={
                                    router.pathname === "/admin/users/new"
                                }
                            >
